...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .meta { font-size: 11px; color: #777; text-transform: uppercase; letter-spacing: 3px; margin-bottom: 80px; padding-bottom: 40px; border-bottom: 1px solid #1a1a1a; font-weight: 500; }
    .content p { font-size: 1.15rem; line-height: 2.2; color: #ffffff; font-weight: 300; margin-bottom: 48px; }
    ...
    .content em { font-style: italic; color: #E5E7EB; }
    .content blockquote { border-left: 1px solid ${ACCENT}; padding-left: 32px; margin: 60px 0; font-style: italic; color: #999; font-size: 1.2rem; }
    ...
    .list-item .desc { font-size: 1.1rem; color: #999; line-height: 1.8; font-weight: 300; max-width: 650px; margin-bottom: 40px; }
    ...
    .index-sub { font-size: 1.15rem; color: #777; max-width: 700px; margin: 0 auto 140px; line-height: 1.8; font-weight: 300; text-align: center; font-style: italic; }
  </style>
</head>
<body>
  ${bodyContent}
